...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PdnsApi.ModelRecord();
  });
  ...
  describe('ModelRecord', function() {
    it('should create an instance of ModelRecord', function() {
      // uncomment below and update the code to test ModelRecord
      //var instane = new PdnsApi.ModelRecord();
      //expect(instance).to.be.a(PdnsApi.ModelRecord);
    });
